...
public class Parameters {
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.PrototypeSecondary"; //class given by name; is supposed to extends robotsimulator.Brain
