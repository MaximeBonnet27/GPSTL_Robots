...
public class Parameters {
  ...
  public static final String teamAMainBotBrainClassName = "algorithms.Prototype"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.Prototype"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBMainBotBrainClassName = "algorithms.Prototype"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.Prototype"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final double teamBSecondaryBotRadius = 50, //1 unit = 1mm, body radius
                             ...
                             teamBSecondaryBotSpeed = 15, //1 unit = 1mm, distance performed at step movement
